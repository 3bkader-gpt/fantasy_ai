...
المطلوب:
اكتب تقريراً تكتيكياً شاملاً، متكاملاً، ومقنعاً باللغة العربية يشمل:
...
- كن دقيقاً وحاسماً وواضح العبارة دون إسهاب زائد أو تكرار.
- أنهِ كل نقطة من النقاط الخمس بفكرة مكتملة تماماً، واختم التقرير بفقرة "الخلاصة التنفيذية" دون أن تترك أي جملة معلقة في النهاية.
"""
